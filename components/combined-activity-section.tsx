...
const interests = [
  ...
  },
  {
    name: "Gardening",
    icon: Leaf,
    color: "bg-emerald-500 dark:bg-emerald-700",
  },
...
const learningItems = [
  ...
  },
  {
    ...
    items: [
      {
        name: "Small Pieces Loosely Joined: A Unified Theory Of The Web",
        source: "Book",
        icon: Book,
      },
    ],
  },
  {
    ...
    icon: Headphones,
    items: [
      { name: "Women in STEM podcast", source: "Podcast", icon: Headphones },
    ],
  },
];
      ...
      <div className="grid grid-cols-1 gap-3 sm:gap-6 md:grid-cols-2 lg:grid-cols-2">
        ...
        <div className="relative p-3 sm:p-6 border border-purple-200 dark:border-purple-900/30 rounded-xl bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-purple-950 gradient-card backdrop-blur-sm shadow-xl transition-colors duration-300 h-full floating-card">
          ...
          `}
                ...
                >
                  <div
                    className={`absolute inset-0 opacity-20 ${interest.color}`}
                  ></div>
        ...
        <div className="relative p-3 sm:p-6 border border-purple-200 dark:border-purple-900/30 rounded-xl bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-purple-950 gradient-card backdrop-blur-sm shadow-xl transition-colors duration-300 h-full floating-card">
          <div className="relative">
            ...
            <a
              href="https://www.codewars.com/users/daniellem62"
              target="_blank"
                  ...
                  <div className="flex flex-wrap gap-1 sm:gap-2 pl-3 sm:pl-5">
                    {category.items.map((item, index) => (
                      ...
                      >
                        ...
                        <p className="text-purple-700 dark:text-gray-300 text-[8px] sm:text-xs">
                          {item.name}
                        </p>
                      </motion.div>
                    ))}
