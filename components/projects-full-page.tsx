    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-6">
        {filteredProjects.map((project, index) => (
          <div
            key={index}
            className="group relative bg-white dark:bg-gray-900 rounded-xl overflow-hidden border border-purple-200 dark:border-gray-800 hover:border-purple-500/50 transition-all duration-300 shadow-md cursor-pointer hover:shadow-lg"
          ...
          >
            ...
            <div className="relative overflow-hidden h-32 sm:h-[240px]">
              <Image
            ...
            <div className="p-2 sm:p-6">
              <div className="flex items-center justify-between mb-1 sm:mb-4">
                <h3 className="text-sm sm:text-xl font-semibold text-purple-800 dark:text-white">
                  {project.title}
                </h3>
                <div
              ...
              <p className="text-xs sm:text-base text-gray-700 dark:text-gray-300 mb-2 sm:mb-6 line-clamp-3 sm:line-clamp-3">
                {project.description}
              </p>
              ...
              <div className="flex flex-wrap gap-1 sm:gap-2 mb-2 sm:mb-6">
                ...
                {/* Show the +X badge when there are more than 3 techs */}
      ...
      {/* Expanded Card Modal - Rendered outside grid for proper centering */}
      {expandedCard && (
        <>
          <div
